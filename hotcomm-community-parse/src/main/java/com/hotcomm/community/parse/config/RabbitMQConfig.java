package com.hotcomm.community.parse.config;
...
import com.hotcomm.community.parse.analy.Analysis;
import com.hotcomm.community.parse.service.MyTask;
import com.hotcomm.community.parse.utils.ThreadPool;
...
public class RabbitMQConfig {
	...
	public void publishMessage(String message) {
		logger.info("rabbitmq数据：{}", message);
