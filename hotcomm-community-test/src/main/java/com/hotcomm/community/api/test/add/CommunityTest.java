...
public class CommunityTest {
    ...
    protected final static String host = "http://47.105.156.159:8281/wisdom/";
    ...
    private final static Integer REDIS_DATABASE_INDEX = 13;
    ...
    public static void loginToToken() throws Exception {
	    ...
	    if(communityDetailList.size()==0) return;
